...
%% @end
node_register(IPaddress, Port, PublicKey) when is_list(IPaddress), is_integer(Port), is_list(PublicKey) -> 
...
%% @end
node_unregister(IPaddress, Port, PublicKey) when is_list(IPaddress), is_integer(Port), is_list(PublicKey) ->
